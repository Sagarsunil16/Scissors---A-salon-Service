...
const reviewService:IReviewService =  new ReviewService(reviewRepository,appointmentService)
const offerService:IOfferService = new OfferService(offerRepository)
const bookingService:IBookingService = new BookingService(timeSlotService,salonService,offerService,reviewService,appointmentService,walletService)
...
export {messageService,salonService,userService,appointmentController,adminController,bookingController,categoryController,chatController,messageController,offerController,reviewController,salonController,serviceController,stylistController,userController,expiredReservations,walletController,adminDashboardController,salonDashboardController,authController };

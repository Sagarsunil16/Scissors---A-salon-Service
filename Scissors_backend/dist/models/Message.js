...
const MessageSchema = new mongoose_1.Schema({
    chatId: { type: mongoose_1.Schema.Types.ObjectId, required: true, ref: "Chat" }, //link to chat
    ...
    recipientId: { type: mongoose_1.Schema.Types.ObjectId, required: true, refPath: 'recipientType' },
    recipientType: { type: String, enum: ["User", "Salon"], required: true },
    image: { type: String, default: "" },
    timestamp: { type: Date, default: Date.now },
    isRead: { type: Boolean, default: false }, //track read status
    reactions: [{ userId: mongoose_1.Schema.Types.ObjectId, emoji: String }] //store reactions 
}, { timestamps: true });

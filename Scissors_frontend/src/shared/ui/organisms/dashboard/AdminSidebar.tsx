...
import { Grid2X2, Layers3, LogOut, Menu, Scissors, Store, Users, X } from "lucide-react";
import BrandMark from "@/shared/ui/atoms/BrandMark";
import { signOut } from "@/Redux/Admin/adminSlice";
import { signOutAdmin } from "@/features/admin/api/adminAPI";
import { getErrorMessage } from "@/shared/lib/errors";

const navItems = [
  { label: "Dashboard", to: "/admin/dashboard", icon: Grid2X2 },
  { label: "Category", to: "/admin/category", icon: Layers3 },
  { label: "Services", to: "/admin/service", icon: Scissors },
  { label: "Salons", to: "/admin/salons", icon: Store },
